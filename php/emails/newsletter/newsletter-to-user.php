      ...
      <tr style="background-color: #FFFFFF;">
        <td style="padding: 40px;">
          ...
          <h2 class="fallback-font"
            ...
            <strong>Hola {email_user}, Como estas?</strong>
          </h2>
          ...
          <p class="fallback-font"
            ...
            Desde {name_client} queremos agradecer tu suscripción a nuestro newsletter. Estaras recibiendo nuestras
            novedades.
          </p>
          <br>
          <br>
      ...
      <tr style="background-color: #FF0000;">
        <td style="background-color: #FF0000; text-align: center; padding: 40px;">
          ...
          <p class="fallback-font"
            ...
            <strong>¿Necesitas realizar una consulta?</strong>
          </p>
          <!-- Button : BEGIN -->
            ...
            <tr>
              <td class="button-td button-td-primary" style="border-radius: 4px; background: #FFFFFF;">
                <a class="fallback-font button-a button-a-primary" target="_blank" rel="noopener" href="{base}"
                  style="background: #FFFFFF; border: 1px solid #FFFFFF; font-family: 'Montserrat', sans-serif; font-size: 18px; line-height: 28px; font-weight: 700; text-decoration: none; padding: 10px 20px; color: #FF0000; display: block; border-radius: 4px;">VER
                  MÁS
                </a>
              </td>
            </tr>
