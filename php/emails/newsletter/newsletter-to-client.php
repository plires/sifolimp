...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f6f6f6;">
  <center style="width: 100%; background-color: #f6f6f6;">
    ...
    <div class="fallback-font"
      ...
      nueva suscripci&oacute;n al newsletter.
    </div>
      ...
      <tr style="background-color: #FF0000;">
        <td style="padding: 10px 5px; vertical-align: middle;">
          ...
          <h1 class="fallback-font"
            ...
            <strong>Nueva suscripci&oacute;n desde {origin}</strong>
          </h1>
      ...
      <tr style="background-color: #FF0000;">
        <td style="background-color: #FF0000; text-align: center; padding: 40px;">
          ...
          <p class="fallback-font"
            ...
            <strong>¿Necesitas contactar a este usuario?</strong>
          </p>
          <!-- Button : BEGIN -->
            ...
            <tr>
              <td class="button-td button-td-primary" style="border-radius: 4px; background: #FFFFFF;">
                <a class="fallback-font button-a button-a-primary" target="_blank" rel="noopener"
                  ...
                  style="background: #FFFFFF; border: 1px solid #FFFFFF; font-family: 'Montserrat', sans-serif; font-size: 18px; line-height: 28px; font-weight: 700; text-decoration: none; padding: 10px 20px; color: #FF0000; display: block; border-radius: 4px;">RESPONDER
                </a>
              </td>
            </tr>
          </table>
